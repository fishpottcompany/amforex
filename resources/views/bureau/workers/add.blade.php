                ...
                <div class="col-lg-12 col-md-12">
                  <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="password" minlength="4" maxlength="8" name="new_worker_pin" class="form-control" >
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label for="worker_flagged">Flag Worker</label>
                          <select name="worker_flagged" class="form-control" id="worker_flagged"  required="required">
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_customer" value="worker_add-customer"> Add Customer
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_customers" value="worker_view-customers"> View Customers' List
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_get_one_customer" value="worker_get-one-customer"> View One Customer
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_rate" value="worker_add-rate"> Add Rate
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_rates" value="worker_view-rates"> View Rates
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_get_one_rate" value="worker_get-one-rate"> View One Rate
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_update_rate" value="worker_update-rate"> Update Rate
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_stock" value="worker_add-stock"> Add Currency Stock
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_stocks" value="worker_view-stocks"> View Currencies' Stock
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_trade" value="worker_add-trade"> Make Trades
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <!--
                        ...
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_edit-trade" value="worker_edit-trade"> View Currency Stock
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_trades" value="worker_view-trades"> View Trades
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_branch" value="worker_add-branch"> Add Branch
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_branches" value="worker_view-branches"> View Branches
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_add_worker" value="worker_add-worker"> Add Worker
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                    ...
                    <div class="row">
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_edit_worker" value="worker_edit-worker"> Edit Worker
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_currencies" value="worker_view-currencies"> View Currencies
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
                      ...
                      <div class="col-md-3">
                        <div class="form-check form-check-inline">
                          <label class="form-check-label">
                            <input class="form-check-input" type="checkbox" name="worker_view_workers" value="worker_view-workers"> View Workers
                            <span class="form-check-sign">
                                <span class="check"></span>
                            </span>
                          </label>
