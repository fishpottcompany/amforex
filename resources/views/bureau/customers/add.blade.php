                ...
                <div class="col-lg-12 col-md-12">
                  <div class="card">
                    <div class="card-header card-header-warning">
                      ...
                      <p class="card-category">Add a customer to trade with.</p>
                    </div>
                    <div class="card-body">
                      ...
                      <form id="acform">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="bmd-label-floating">Customer First Name</label>
                              <input type="text" name="customer_firstname" maxlength="100" class="form-control" required="required">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="customer_surname" maxlength="100" class="form-control" required="required">
                            </div>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="bmd-label-floating">Customer Other Names</label>
                              <input type="text" name="customer_othernames" maxlength="100" class="form-control" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="customer_email" maxlength="100" class="form-control" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              <label class="bmd-label-floating">Customer ID Number</label>
                              <input type="text" name="customer_id_1_number" maxlength="50" class="form-control" >
                            </div>
                          </div>
                        </div>
                        <div class="row">
