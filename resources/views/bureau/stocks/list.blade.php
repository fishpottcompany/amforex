            ...
            <div class="container-fluid">
                    ...
                    <form class="navbar-form" id="search_form">
                      ...
                      <table class="table table-hover" id="list_table" style="display: none;">
                        <thead class="text-warning">
                          ...
                          <th class="font-weight-bold">New Stock</th>
                        </thead>
              ...
              <div class="row">
                <div class="offset-lg-5 col-lg-4 offset-md-5 col-md-4" id="pagination_buttons">
                  <a id="previous_btn" class="btn btn-default" href="<?php echo url('/'); ?>/bureau/stocks/list/?page=<?php if(isset($_GET["page"]) && intval($_GET["page"]) > 1){echo intval($_GET["page"])-1;} else {echo "1"; } ?>"><i class="material-icons">keyboard_arrow_left</i></a>
                  <a id="next_btn" style="display: none" class="btn btn-default" href="<?php echo url('/'); ?>/bureau/stocks/list/?page=<?php if(isset($_GET["page"]) && intval($_GET["page"]) > 0){echo intval($_GET["page"])+1;} else {echo "1"; } ?>"><i class="material-icons">keyboard_arrow_right</i></a>
                </div>
              </div>
            </div>
          </div>
...
@section('footer');
    ...
    <script type="text/javascript">
      get_stocks_for_page('<?php if(isset($_GET["page"]) && intval($_GET["page"]) > 0){echo intval($_GET["page"]);} else {echo "1"; } ?>');
    </script>
  </body>
  </body>
  </html>
